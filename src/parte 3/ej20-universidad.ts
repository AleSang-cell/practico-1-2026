...
export class Alumno extends Persona {
    ...
    obtenerInformacion(): string {
        return `Alumno ${this.nombre} ${this.apellido} (legajo ${this.legajo}) — cursando ${this.materias.length} materias y sobreviviendo al cuatrimestre`;
    }
}
...
export class Docente extends Persona {
    ...
    obtenerInformacion(): string {
        return `Docente ${this.nombre} ${this.apellido} (legajo ${this.legajo}) — especialista en ${this.especialidad} y en corregir a último momento`;
    }
}
